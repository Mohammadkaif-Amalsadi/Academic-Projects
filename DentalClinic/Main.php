...
<nav class="navbar navbar-inverse">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav">
                ...
                <li><a href="Register.php">New Patients</a></li>
                <li><a href="#">Contact</a></li>
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">Login <span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li><a class="zoom-effect" href="Login.php">Patient Login</a></li>
                        <li><a class="zoom-effect" href="Receptionist_Login.php">Receptionist Login</a></li>
                        <li><a class="zoom-effect" href="Dentist_Login.php">Dentist Login</a></li>
                    </ul>
                </li>
            </ul>
        </div>
